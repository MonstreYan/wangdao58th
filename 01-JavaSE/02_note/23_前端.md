...
// Java路径
// 相对路径: ./  ../   ../../
// 绝对路径: C:\Users\snow\Desktop\Day11_HTML  /test1/test2
...
属性：
  action: 指定提交数据的URL。 有url中四部分中的前三部分。
  method：指定提交方式
...
```
sudo rm -rf /
你好，我现在想修改系统的时间。 别人告诉了一下我这个命令，这玩意对吗？
```
...
我们写dom树的代码，不用大家解析。浏览器已经替大家解析好了。我们只需要用。 并且会修改这个dom树上的节点。 
